...
{
    public class Translator<TObject>
    {
        string options;
        ...
        public Translator(IFactoryObjectPropertyComparer<TObject> factoryObjectPropertyComparer, string defaultOptions, char orderSeparator = '-', char propertySeparator = ',')
        {
